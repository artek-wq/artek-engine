                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="relative">
                      <Button
                        ...
                        size="icon"
                        className="h-8 w-8"
                        onClick={(e) => { e.stopPropagation(); setOpenMenuId(openMenuId === madre.id ? null : madre.id); }}
                      >
                      ...
                      {openMenuId === madre.id && (
                        ...
                        >
                          <button className="w-full text-left px-4 py-2 text-sm hover:bg-slate-50 transition"
                            onClick={() => { setOpenMenuId(null); setSelectedOperacion(madre); setDialogOpen(true); }}>
                            Editar
                          </button>
                          <button className="w-full text-left px-4 py-2 text-sm hover:bg-slate-50 text-red-600 transition"
                            onClick={() => { setOpenMenuId(null); handleDelete(madre); }}>
                            Eliminar
                          </button>
                          <button className="w-full text-left px-4 py-2 text-sm hover:bg-slate-50 transition"
                            onClick={() => { setOpenMenuId(null); setParentForSub(madre); setSubDialogOpen(true); }}>
                            Crear Sub-Operación
                          </button>
                        </div>
                      )}
